        ...
        if (widget.userData['assets'].length == 0) {
          return Scaffold(
            body: Column(
              children: [
                Padding(
                  padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width/2 - 110, 53.0, 8.0, 0),
                  child: ListTile(
                    leading: SizedBox(
                      height: 50,
                      width: 50,
                      ...
                      child: Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Hero(
                                tag: widget.userData['email'].split('@')[0] + " worth",
                                child: Material(
                                    color: Colors.transparent,
                      ...
                      child: Align(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Material(
                                color: Colors.transparent,
                                child: Text("Balance: \$${widget.userData['USD'].toStringAsFixed(2)}")
                            ),
                ...
                const Flexible(child: Center(child: Text("This user has no assets yet!"))),
              ],
            ),
          );
        } else {
          futureCharts = fetchCharts(1, widget.userData['assets'], widget.nomicsApi);
          return Scaffold(
            body: LazyLoadScrollView(
              onEndOfPage: () async {
                ...
                try {
                  localCharts =
                  await fetchCharts(page.round(), widget.userData['assets'], widget.nomicsApi);
                } catch (err) {
                  localCharts = await Future.delayed(
                      const Duration(seconds: 1), () async {
                    return await fetchCharts(page.round(), widget.userData['assets'], widget.nomicsApi);
                  });
                }
              ...
              child: RefreshIndicator(
                child: SingleChildScrollView(
                  ...
                  child: Column(
                    children: [
                      Padding(
                        padding: EdgeInsets.fromLTRB(MediaQuery.of(context).size.width/2 - 110, 53.0, 8.0, 61.0),
                        child: ListTile(
                          leading: SizedBox(
                            height: 50,
                            width: 50,
                                  ...
                                  builder: (context, snapshot) {
                                    if (snapshot.hasData) {
                                      ...
                                      return Wallet(
                                        ...
                                        rate: widget.userData[snapshot.data![1][index]["id"]]
                                            .toString(),
                                        day: (() {
                                          try {
                ...
                onRefresh: () {
                  return Future.delayed(const Duration(seconds: 0), () async {
                    var chartData = await fetchCharts(1, widget.userData['assets'], widget.nomicsApi);
                    setState(() {
                      futureCharts =
                          Future.delayed(const Duration(seconds: 0), () {
                            return chartData;
