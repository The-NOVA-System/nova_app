...
class ContactUs extends StatelessWidget {
  ...
  /// font of the company/individual to be displayed
  final String? companyFont;

  /// font of the tagline to be displayed
  final String? taglineFont;

  /// divider color which is placed between the tagline & contact information's
  final Color? dividerColor;

  /// divider thickness which is placed between the tagline & contact information
  ...
  /// avatar radius will place the circular avatar according to developer/UI need
    ...
    return SafeArea(
      child: SingleChildScrollView(
        child: Column(
          ...
          children: <Widget>[
            Padding(
              padding: EdgeInsets.fromLTRB(avatarPadding, avatarPadding - 25, avatarPadding, avatarPadding),
              child: Visibility(
                visible: logo != null,
                child: CircleAvatar(
            ...
            Card(
              ...
              color: cardColor,
              child: ListTile(
                leading: Icon(Typicons.mail, color: textColor),
                title: Text(
                  emailText ?? 'Email ID',
                  style: TextStyle(
                    color: textColor,
            ...
            Visibility(
              ...
              child: Card(
                ...
                color: cardColor,
                child: ListTile(
                  leading: Icon(Typicons.social_twitter, color: textColor),
                  title: Text(
                    'Twitter',
                    style: TextStyle(
                      color: textColor,
            ...
            Visibility(
              ...
              child: Card(
                ...
                color: cardColor,
                child: ListTile(
                  leading: Icon(Typicons.social_facebook, color: textColor),
                  title: Text(
                    'Facebook',
                    style: TextStyle(
                      color: textColor,
            ...
            Visibility(
              ...
              child: Card(
                ...
                color: cardColor,
                child: ListTile(
                  leading: Icon(Typicons.social_instagram, color: textColor),
                  title: Text(
                    'Instagram',
                    style: TextStyle(
                      color: textColor,
            ...
            Visibility(
              ...
              child: Card(
                ...
                color: cardColor,
                child: ListTile(
                  leading: Icon(Typicons.social_github, color: textColor),
                  title: Text(
                    'Github',
                    style: TextStyle(
                      color: textColor,
            ...
            Visibility(
              ...
              child: Card(
                ...
                color: cardColor,
                child: ListTile(
                  leading: Icon(Typicons.social_linkedin, color: textColor),
                  title: Text(
                    'Linkedin',
                    style: TextStyle(
                      color: textColor,
