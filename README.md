...
The Nova System is an educational app that mimics a cryptocurrency trading environment to let people learn without
spending. The app has been used in classrooms to introduce cryptocurrencies to students in a fun and engaging manner, in
addition to other classroom resources.
